...
import doctorHero from "../assets/heroDoctor.png"
...
const Hero: FC = () => {
  ...
  return (
    ...
    <>
      <div className="font-sans text-[#333] max-w-7xl max-md:max-w-md mx-auto ">
        <div className="grid md:grid-cols-2 items-center md:gap-8 gap-6">
          ...
          <div className="lg:h-[550px] md:h-[550px] flex items-center relative max-md:before:hidden before:absolute  before:h-[120%] before:w-[120%] before:right-0 before:z-0 z-0">
            <img src={doctorHero} className="rounded-md lg:w-4/5 z-50 relative" alt="Dining Experience" />
          </div>
        </div>
        <div className="grid md:grid-cols-3 gap-4 z-50 relative md:px-4 max-md:mt-10 bg-gradient-to-r from-cyan-500 to-blue-500  hover:bg-gradient-to-l rounded-full">
          <div className="bg-blur p-6 ml-6">
            ...
            <h3 className="text-xl text-white font-bold mb-2">Customization</h3>
            <p className="text-sm text-white">Tailor our product to suit your needs.</p>
            <a href="javascript:void(0);" className="text-white font-bold inline-block text-sm mt-2 hover:underline">Learn more</a>
          </div>
          <div className="bg-blur p-6">
            ...
            <p className="text-sm text-white">24/7 customer support for all your inquiries.</p>
            <a href="javascript:void(0);" className="text-white font-bold inline-block text-sm mt-2 hover:underline">Learn more</a>
          </div>
          <div className="bg-blur p-6">
            ...
            <h3 className="text-xl text-white font-bold mb-2">Performance</h3>
            <p className="text-sm text-white">Experience blazing-fast performance with our product.</p>
            <a href="javascript:void(0);" className="text-white font-bold inline-block text-sm mt-2 hover:underline">Learn more</a>
          </div>
        </div>
      </div>
